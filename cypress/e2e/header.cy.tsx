describe("LandingNavigation", () => {
  ...
  it("should navigate to About page when About link is clicked", () => {
    ...
    // Verifying that the user is redirected to the About page
  ...
  it("should navigate to Search page when Search link is clicked", () => {
    ...
    // Verifying that the user is redirected to the Search page
  ...
  it("should navigate to Login page when Login button is clicked", () => {
    ...
    // Verifying that the user is redirected to the Login page
  ...
  it("should navigate to Signup page when Signup button is clicked", () => {
    ...
    // Verifying that the user is redirected to the Signup page
